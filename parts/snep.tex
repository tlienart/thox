...
Explain that just choice to go for $\omega$ vs $\lambda$ and that in fact not clear cut.\\
Explain that more advanced examples with Neural Networks presented in the paper but with Diagonal Gaussian (+ it's not your work so leave it aside)
}