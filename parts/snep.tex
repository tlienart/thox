...
In this chapter, we show how different variants of the EP algorithm can be used to perform parallel variational inference in the presence of distributed data.\add{come back to this, add litt, see also confirmation}
...
This is what Minka calls the \emph{EP dual energy function} \citep{minka01c}.\add{This is full of shit, its a minimisation on a collapsed domain, should refrain from using if possible...}
