...
\dred{need to rephrase this entry}
...
Such a graph represents the factorisation structure of a class of probability density functions that can be written as
