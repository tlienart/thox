...
\todofr{
\begin{itemize}
	\item general stuff, discuss variational inference in general. don't really need VB so introduce it very briefly
	\item ORDERING: could do EPBP after EP for distributed because then the whole of EP is already discussed... 
