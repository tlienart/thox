...
\eqa{
	H(x, p) &:=& -\ell(x) + \frac12\scal{p, M\inv p} 
}
...
It is a very popular method in computational Bayesian inference and tends to be preferred over approaches such as the MH algorithm \citep{green15}.
